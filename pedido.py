...
if __name__ == '__main__':
    ...
    estudiante = Estudiante(cedula="0927597021", nombre="Joseph", apellido="Montenegro", email="josephmgbsc@gmail.com",telefono="0985380771", direccion="Suburbio",  numero_libros=1, activo=True, carrera="Gestión de la información gerencial")
    ...
    docente = Docente(cedula="0945123614", nombre="Eduardo", apellido="Gonzalez", email="eduardogonzalez@gmail.com",telefono="0974123652", direccion="Alborada",  numero_libros=3, activo=True, carrera="Ciencias de la Computación", id_docente="DOC001", titulo_3er_nivel="Ph.D. en Ciencias de la Computación", titulo_4to_nivel="")
