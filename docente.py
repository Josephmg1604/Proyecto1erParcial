...
def main():
    docen1 = Docente(cedula="0957752322", nombre="0957752322", apellido="Iza", email="sweet_eli97@outlook.es", telefono="0939784624", direccion="28 y maldonado", numero_libros=1, activo=True, carrera="Gestión de la información gerencial", id_docente=101, titulo_3er_nivel="no", titulo_4to_nivel="no")
    print(docen1)
    docen2 = Docente(cedula="0943308221", nombre="Daniela", apellido="Ochoa", email="daniela.ochoa@ug.edu.ec", telefono="093945678", direccion="46 y Nicolás Agusto González",numero_libros=3, activo=True, carrera="Gestión de la información gerencial", id_docente=202, titulo_3er_nivel="no", titulo_4to_nivel="si")
    print(docen2)
    docen3 = Docente(cedula="0927597021", nombre="Joseph", apellido="Montenegro", email="josephmgbsc@gmail.com",  telefono="0985381771", direccion="Fco. seguro entre la 37 y 38", numero_libros=2, activo=True,  carrera="Gestión de la información gerencial", id_docente=202, titulo_3er_nivel="no", titulo_4to_nivel="si")
    print(docen3)
